...
import com.example.midtask.mytools.network.requestion.OnRequestion;
...
public class MyThreadTask {
    ...
    public MyThreadTask setDefineAction(OnRequestion.DefineAction defineAction) {
    ...
    public MyThreadTask setOnRequestion(OnRequestion onRequestion) {
